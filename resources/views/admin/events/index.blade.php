...
<header class="flex justify-between items-center mb-10">
            <div>
                <h1 class="text-3xl font-black">Selamat datang admin :D</h1>
                <p class="text-slate-500 font-medium">ini adalah data event yang mendatang</p>
            </div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <form action="{{ route('admin.events.destroy', $event->id) }}"
                                ...
                                <a href="{{ route('admin.events.edit', $event->id) }}"
                                   class="inline-flex items-center justify-center w-10 h-10 bg-indigo-50 text-indigo-600 rounded-xl hover:bg-indigo-600 hover:text-white transition">
                                    <svg class="w-5 h-5"
                                         fill="none"
                                         stroke="currentColor"
                                         viewBox="0 0 24 24">
